...
\input{ganesha-atharva-sheersham.tex}
\input{purusha-sooktam.tex}
\input{narayana-sooktam.tex}
\input{vishnu-sooktam.tex}
\input{boo-sooktam.tex}
\input{neela-sooktam.tex}
\input{durga-sooktam.tex}
\input{sri-sooktam.tex}
\input{medha-sooktam.tex}
\input{pavamana-sooktam.tex}
\input{gosha-shanthi.tex}
\input{pancha-shanthi.tex}
