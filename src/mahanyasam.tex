...
\input{mahanyasam/first_nyasas.tex}
\input{mahanyasam/hamsa-gayathri.tex}
\input{mahanyasam/sangaya.tex}
\input{mahanyasam/pipruhi.tex}
\input{mahanyasam/before_shiva_sankalpam.tex}
\input{mahanyasam/shiva_sankalpam.tex}
\input{mahanyasam/purusha-sooktam.tex}
\input{mahanyasam/aprathiratam.tex}
\input{mahanyasam/tvamagne_rudro.tex}
\input{mahanyasam/namaskaram.tex}
\input{mahanyasam/laghunyasam.tex}
\input{mahanyasam/rudram.tex}
\input{mahanyasam/chamakam.tex}
\input{mahanyasam/rudram-trishathi.tex}
\input{mahanyasam/shivopasana_mantram.tex}
\input{mahanyasam/kramam.tex}
\input{mahanyasam/ganam.tex}
